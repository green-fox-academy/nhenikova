...
//Now you are going to create a simple hospital simulator game.
// We will need patients, a hospital and different kinds of queues to handle
// our patients. You can implement the necessary classes in any order, but I
// suggest you to follow the descriptions below.
//
//
//Patient class
...
//The severity is a random number between 1 and 10, you can set it in
// the constructor or at the field declaration. Keep in mind, the severity cannot go below 0
//
//
//Queue class
//If you have Patients you can create an abstract Queue class. It will hold
...
//
//Hospital class
//Since you have Queue class and Patients you can implement your Hospital
...
//
//SafeQueue class
//The safe queue is a special queue which is not abstract anymore.
// Its method to retrieve the next patient has the following specification
//
//- It always returns the patient with the highest severity.
//- If there are more patients with the same severity you can pick one, it is up
// to you which one is returned.
...
//- Patients with 0 severity won't be returned ever. (You can remove them from the queue or
// just simple skip them)